...
const VideoDescriptionComponent: React.FC<VideoDescriptionComponentProps> = ({ description, isLoading, error }) => {
  ...
  if (error) {
    return (
      <div className="text-red-500 p-4 bg-red-100 rounded-lg shadow-md mt-4 h-[600px] flex items-center justify-center">
        <p>Error: {error}</p>
      </div>
    );
  }
  ...
  if (!description) {
    return (
      <div className="text-gray-600 p-4 bg-gray-100 rounded-lg shadow-md mt-4 h-[600px] flex items-center justify-center">
  ...
  return (
    <div className="space-y-1 p-6 bg-white rounded-lg shadow-md mt-4 h-full overflow-y-auto custom-scrollbar">
      ...
      <div>
        ...
        <p className="bg-gray-50 p-4 text-l rounded-md font-medium text-gray-900 border border-gray-200">
          {description.title || 'No title available'}
        </p>
      </div>

      <div>
        <h3 className="text-l font-semibold mb-2 text-gray-700">Category Tags</h3>
        <p className="bg-gray-50 p-4 text-xs rounded-md italic text-gray-700 border border-gray-200">
      ...
      <div>
        <h3 className="text-l font-semibold mb-2 text-gray-700">Keywords</h3>
        <p className="bg-gray-50 p-4 text-xs rounded-md italic text-gray-700 border border-gray-200">
      ...
      <div>
        <h3 className="text-l font-semibold mb-2 text-gray-700">Detailed Description</h3>
        <ul className="list-disc pl-5  text-xs bg-gray-50 p-4 rounded-md text-gray-800 border border-gray-200">
      ...
      <div>
        <h3 className="text-l font-semibold mb-2 text-gray-700">Summary</h3>
        <div className="bg-gray-50  text-xs p-4 rounded-md text-gray-800 border border-gray-200">
